...
* 
*  Name: Keith Cao Student ID: 1443332211 Date: June 2, 2023 
*  Render Link: https://assignment2-dr3j.onrender.com
*
********************************************************************************/ 
...
function loadMovieData(title=null) {
    moviesApi = `https://zany-gray-starfish-wrap.cyclic.app/api/movies?page=${page}&perPage=${perPage}`;
...
function movieClick(id) {
    fetch("https://zany-gray-starfish-wrap.cyclic.app/api/movies/"+id)
    .then((res) => res.json())
    .then((movie) => {
